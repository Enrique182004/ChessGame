...
1. **Select a Piece**: Choose from King, Queen, Rook, Bishop, Knight, or Pawn
2. **Choose Color**: Select WHITE or BLACK
3. **Set Initial Position**: Use the dropdown menus to select column (a-h) and row (1-8)
4. **Place Piece**: Click "Place Piece" to add it to the board
5. **Move the Piece**: Select a target position and click "Move Piece"
6. **Start Over**: Click "New Piece" to clear the board and try a different piece
